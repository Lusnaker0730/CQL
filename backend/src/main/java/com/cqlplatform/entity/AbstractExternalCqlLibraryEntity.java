...
/**
 * Shared base for CDS and eCQM external CQL library entities.
 * Contains all columns, JSON serialization lifecycle hooks, and utility methods.
 */
@MappedSuperclass
@Data
@SuperBuilder
@NoArgsConstructor
@AllArgsConstructor
public abstract class AbstractExternalCqlLibraryEntity {
