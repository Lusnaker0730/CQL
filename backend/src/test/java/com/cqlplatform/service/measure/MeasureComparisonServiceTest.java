...
class MeasureComparisonServiceTest {
    ...
    void comparePeriods_bothPeriodsHaveData_shouldCalculateDelta() {
        ...
        when(reportService.getReportsForPeriod("Test", p1Start, p1End))
                .thenReturn(List.of(createReport(0.70, 100)));
        when(reportService.getReportsForPeriod("Test", p2Start, p2End))
                .thenReturn(List.of(createReport(0.85, 120)));

        MeasureComparisonResult result = service.comparePeriods("Test", p1Start, p1End, p2Start, p2End);
    ...
    void getTrend_shouldReturnOrderedDataPoints() {
        ...
        when(reportService.getReportsByMeasureNameOrderByPeriod("Test"))
                .thenReturn(List.of(r1, r2));

        MeasureTrendResult result = service.getTrend("Test", 5);
    ...
    void getTrend_shouldLimitToPeriodCount() {
        ...
        MeasureTrendResult result = service.getTrend("Test", 2);
