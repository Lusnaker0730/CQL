...
export const cqlTokensProvider: languages.IMonarchLanguage = {
  ...
  // Auto-generated from official CQL ANTLR grammar (cql.g4 keyword rule)
  // Regenerate: python scripts/generate-monarch-tokens.py
  keywords: [...CQL_KEYWORDS],

  // Auto-generated from CQL grammar type constructors + built-in types
  typeKeywords: [...CQL_TYPE_KEYWORDS],
